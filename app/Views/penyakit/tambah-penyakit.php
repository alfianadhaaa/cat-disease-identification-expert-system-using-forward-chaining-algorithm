  ...
  <main>
    <div class="container-fluid px-4">
      <div class="container mb-2">
        <div class="row">
          <div class="col">
            <h1 class="mt-3">Tambah Data Penyakit</h1>
          </div>
      ...
      <form action="/penyakit/simpan" method="post">
        <?= csrf_field(); ?>
        <div class="modal-body">
          ...
          <div class="mb-3 col-sm-6">
            ...
            <input type="text" class="form-control" id="penyakit" name="penyakit" required autofocus>
          </div>
          <div class="mb-3 col-sm-6">
